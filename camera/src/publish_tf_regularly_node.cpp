...
int main(int argc, char** argv)
{
  ...
  volumetric_mapping::OctomapManager manager(node, nh_private);
...
//    std::vector< geometry_msgs::TransformStamped > transforms;
//    try {
//      transforms.push_back(tfBuffer.lookupTransform("odom", "base_link", ros::Time(0)));
//      //transform_stamped.publish(transform);
//      //br.sendTransform(transform);
//      //continue;
...
//    try {
//      transforms.push_back(tfBuffer.lookupTransform("base_link", "laser", ros::Time(0)));
//      //transform_stamped.publish(transform);
//      //br.sendTransform(transform);
//      //continue;
